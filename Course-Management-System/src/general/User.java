...
//Purpose : Binding data related to login activity of students and instructors


class User extends Curriculum
{
	...
	public String getName() 
	{
		...
		else if(getUserProfile().equals("Instructor"))
		{
				return new InstructorData().getInstructorName(userid);
		}
		return "-";
	}
