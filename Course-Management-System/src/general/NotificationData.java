...
public class NotificationData {
	...
	public void addNotification(Notification n)
	{
		try
		{
			...
			pr.setString(3, n.getCurriculumCode());
	...
	public ArrayList<Notification> getNotifications(String curriculumcode,int semoryear,String userprofile,String joinedtime)
	{
		ArrayList<Notification> list=new ArrayList<Notification>();
		try
		{
			String query="select * from notification where curriculumcode='"+curriculumcode+"'  and semoryear="+semoryear+" and userprofile='"+userprofile+"' order by sr_no desc";
			...
			while(rs.next())
			{
				...
				n.setCurriculumCode(rs.getString(3));
	...
	public int getUnreadNotification(String userid,String userprofile,String curriculumcode,int sem,String joinedtime)
	{
		int total=0;
		try
		{
			String query="select readby,time from notification where curriculumcode='"+curriculumcode+"' and semoryear="+sem+" and userprofile='"+userprofile+"'";
			Statement st=con.createStatement();
