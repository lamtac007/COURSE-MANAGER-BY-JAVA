...
import general.HintPasswordField;
...
public class LoginPanel extends JPanel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		else if(loginprofile.equals("Instructor"))
		{
			boolean result=new InstructorData().checkPassword(useridfield.getText(), passwordfield.getText());
			if(result==true)
			{
				Instructor f=new InstructorData().getInstructorInfobyUserId(useridfield.getText());
				if(!f.getCurriculumCode().equals("Not Assigned"))
				{
				
					new UserData().addInstructorLoginTime(f);
					InstructorMain fm=new InstructorMain(f);
					fm.setVisible(true);
