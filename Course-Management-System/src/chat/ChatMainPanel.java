...
public class ChatMainPanel extends JPanel {
	...
	public ChatMainPanel(InstructorMain fm)
	{
		this();
		this.fm=fm;
		...
		chatpanel.setVisible(true);
		add(chatpanel);
		chatpanel.setFromUserData(fm.f.getInstructorId()+"",fm.f.getInstructorName(), fm.f.getProfilePic());
		...
		chatinfopanel.setInstructor(fm.f);
		profilepiclabel.addMouseListener(new MouseAdapter()
		{
			public void mousePressed(MouseEvent e)
			{
