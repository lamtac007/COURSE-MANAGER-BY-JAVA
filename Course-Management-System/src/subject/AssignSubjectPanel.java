...
//Purpose : Displaying all the instructor with assigned subject
...
public class AssignSubjectPanel extends JPanel {
		...
		table.addMouseListener(new MouseAdapter()
			{
				public void mousePressed(MouseEvent e)
				{
					...
					Instructor f=new InstructorData().getInstructorInfo(t.getSelectedRow()+1);
	...
	public AssignSubjectPanel(InstructorMain fm)
	{
		this();
		condition=" where curriculumcode='"+fm.f.getCurriculumCode()+"' and semoryear="+fm.f.getSemorYear()+" ";
	...
	private AssignSubjectPanel() {
		...
		JLabel allfaculitieslabel = new JLabel("Subject Instructors");
...
//				table.setEnabled(false);
	...
	{
		ResultSet rs=new InstructorData().getInstructorSubjectInfo(condition);
