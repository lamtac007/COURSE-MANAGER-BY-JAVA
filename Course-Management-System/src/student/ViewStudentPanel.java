...
*/
	private ViewStudentPanel(Student s)
	{
		...
		lblCurriculum.setOpaque(true);
		lblCurriculum.setHorizontalAlignment(SwingConstants.RIGHT);
		lblCurriculum.setFont(new Font("Segoe UI Historic", Font.PLAIN, 20));
		lblCurriculum.setBorder(new LineBorder(new Color(192, 192, 192)));
		lblCurriculum.setBackground(Color.WHITE);
		lblCurriculum.setBounds(20, 359+150, 291, 48);
		add(lblCurriculum);
		...
		JLabel curriculumnamelabel = new JLabel("  "+new CurriculumData().getcurriculumname(s.getCurriculumCode()));
		...
		curriculumnamelabel.setBounds(309, 359+150, 274, 48);
		...
		JLabel semoryearlabel = new JLabel(
				"  " + new CurriculumData().getsemoryear(s.getCurriculumCode()) + "-" + s.getSemorYear() + " " + " (" + s.getCurriculumCode() + ")");
	...
	public ViewStudentPanel(Student s,InstructorMain fm,JComponent lastpanel)
	{
		this(s);
		this.fm=fm;
		this.lastpanel=lastpanel;
