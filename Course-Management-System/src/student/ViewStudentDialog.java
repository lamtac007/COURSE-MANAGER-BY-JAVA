...
public class ViewStudentDialog extends JDialog implements ActionListener
{
	...
	private JComboBox<String> curriculumnamecombo,semoryearcombo,rollnumbercombo;
	...
	public ViewStudentDialog(AdminMain am) {
		...
		curriculumnamecombo.setBounds(170, 98, 320, 43);
		...
		lblCurriculum.setFont(new Font("Microsoft YaHei Light", Font.BOLD, 18));
		lblCurriculum.setBounds(24, 98, 136, 43);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==semoryearcombo)
		{
			if(semoryearcombo.getSelectedIndex()>0)
			{
				String curriculumcode=new CurriculumData().getCurriculumcode(curriculumnamecombo.getSelectedItem()+"");
				int sem=semoryearcombo.getSelectedIndex();
				rollnumbercombo.setModel(new DefaultComboBoxModel<String>(new StudentData().getRollNumber(curriculumcode, sem)));
			}
		}
