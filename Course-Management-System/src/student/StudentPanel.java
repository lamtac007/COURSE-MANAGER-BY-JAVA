...
public class StudentPanel extends JPanel implements ActionListener
{
	...
	public StudentPanel(InstructorMain fm)
	{
		this();
		this.fm=fm;
		condition=" and s.curriculumcode='"+fm.f.getCurriculumCode()+"' and s.semoryear="+fm.f.getSemorYear()+" ";
	...
	public StudentPanel(InstructorMain fm,JComponent lastpanel)
	{
		this();
		this.fm=fm;
		condition=" and s.curriculumcode='"+fm.f.getCurriculumCode()+"' and s.semoryear="+fm.f.getSemorYear()+" ";
	...
	public StudentPanel(StudentMain sm)
	{
		this();
		this.sm=sm;
		condition=" and s.curriculumcode='"+sm.s.getCurriculumCode()+"' and s.semoryear="+sm.s.getSemorYear()+" "+" and userid!='"+sm.s.getUserId()+"'";
		this.createtablemodel();
		this.addstudentbutton.setVisible(false);
		this.viewstudentbutton.setVisible(false);
		this.viewbutton.setLocation(addstudentbutton.getX(), addstudentbutton.getY());
